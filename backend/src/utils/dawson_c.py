...
def aziele_to_radec(azele: tuple[float, float], gps_lat: float, gps_lon: float)->tuple[float, float]:
    """
    ...
    right_ascension = get_local_sidereal_time(gps_lat, gps_lon) - hour_angle
